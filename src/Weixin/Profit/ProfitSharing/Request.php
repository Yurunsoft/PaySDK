...
namespace Yurun\PaySDK\Weixin\Profit\ProfitSharing;
 ...
 * @see https://pay.weixin.qq.com/wiki/doc/api/allocation_sl.php?chapter=25_1&index=1
 */
class Request extends WeixinRequestBase
{
     ...
     * @var string
     */
    public $_apiMethod = 'secapi/pay/profitsharing';
