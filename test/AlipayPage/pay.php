...
// 公共配置
$params = new \Yurun\PaySDK\AlipayPage\Params\PublicParams;
...
// SDK实例化，传入公共配置
$pay = new \Yurun\PaySDK\AlipayPage\SDK($params);

// 支付接口
$request = new \Yurun\PaySDK\AlipayPage\Params\Pay\Request;
